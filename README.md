...
If you are running the project on Linux, you must install the PortAudio library before installing the Python dependencies. This is required for the `sounddevice` package to work correctly.
